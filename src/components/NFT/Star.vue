<template>
  ...
  >
    <path
      ...
      :fill="nftAsset ? (nftAsset.starred ? '#FFE604' : 'white') : 'white'"
      :stroke="nftAsset ? (nftAsset.starred ? '#FFE604' : '#FFFFFF') : '#FFFFFF'"
      stroke-width="2"
    />
    <path
      ...
      :fill="nftAsset ? (nftAsset.starred ? '#FFE604' : '#FFFFFF') : '#FFFFFF'"
    />
  </svg>
</template>
