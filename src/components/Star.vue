<template>
  ...
  >
    <path
      ...
      :fill="nftAsset ? (nftAsset.starred ? '#2CD2CF' : 'white') : 'white'"
      :stroke="nftAsset ? (nftAsset.starred ? '#EAB300' : 'none') : 'none'"
      stroke-width="2"
    />
    <path
      ...
      :fill="nftAsset ? (nftAsset.starred ? '#D9DFE5' : '#D9DFE5') : '#D9DFE5'"
    />
  </svg>
</template>
...
export default {
  ...
  methods: {
    ...
    async toggleStarred() {
      ...
      console.log('🚀 ~ file: Star.vue ~ line 39 ~ toggleStarred ~ this.accountId', this.accountId)
      console.log(
        '🚀 ~ file: Star.vue ~ line 40 ~ toggleStarred ~ this.nftAsset.accountId',
        this.nftAsset.accountId
      )
      const payload = {
