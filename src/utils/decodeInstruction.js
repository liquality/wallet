...
import { Message, StakeInstruction, StakeProgram, SystemInstruction, SystemProgram, PublicKey, Connection } from '@solana/web3.js';
import {
  decodeInstruction,
  Market,
  MARKETS,
...
export const decodeMessage = async (_, _publicKey, message) => {
  // get message object
