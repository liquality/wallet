      ...
      >
        <p class="c7" id="h.gjdgxs">
          <span class="c14 c3">
            ...
            THROUGH THE RELEASE OF SUBSEQUENT VERSIONS, ALL WITH OR WITHOUT NOTICE. THE PLATFORM IS
            IS AVAILABLE ON AN “AS IS” AND “AS AVAILABLE” BASIS FOR THE SOLE PURPOSE OF FEEDBACK ON
            QUALITY, USABILITY, PERFORMANCE AND ANY DEFECTS. THANK YOU FOR YOUR SUPPORT WHILE WE
            CONTINUE TO WORK ON DELIVERING A PERFECT PRODUCT.
          </span>
        </p>
        <p class="c9 c10">
