<template>
  <div class="chain-item" :id="'chain-item-' + chain.code">
    <div class="chain-item-content">
      <img :src="getChainIcon(chain.id)" class="asset-icon chain-item-icon" />
      ...
      <div class="chain-item-toggle" :id="'chain-item-toggle-' + chain.id">
        <toggle-button
          :css-colors="true"
...
import { getAccountIcon, getChainIcon } from '@liquality/wallet-core/dist/utils/accounts'
...
export default {
  ...
  computed: {
    ...
    ...mapState(['activeNetwork', 'activeWalletId', 'enabledChains', 'accounts']),
    accountList() {
